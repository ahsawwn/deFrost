/**
 * Seed Admin/Manager/Cashier Users Script
 * 
 * Usage:
 *   npx tsx scripts/seed-admin.ts
 * 
 * Or with custom values:
 *   ADMIN_EMAIL=admin@example.com ADMIN_PASSWORD=yourpassword ADMIN_NAME="Admin Name" ADMIN_ROLE=admin npx tsx scripts/seed-admin.ts
 * 
